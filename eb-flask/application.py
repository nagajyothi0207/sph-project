...
header_text = '''
    <html>\n<head> <title>URL Monitoring Application</title> </head>\n<body>'''
instructions = '''
    <p><em>Hint</em>: This is a RESTful web service! Append a status
    to the URL (for example: <code>/status</code>) to view the status report of given urls .</p>\n'''
